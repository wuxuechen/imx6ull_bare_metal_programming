//
// Created by hp on 1/29/26.
// 描述	   : LCD驱动文件头文件。
//

#ifndef INC_15_LCD_BSP_LCD_H
#define INC_15_LCD_BSP_LCD_H
#include "imx6ul.h"
...
void lcd_fillrect(unsigned short x0, unsigned short y0, unsigned short x1, unsigned short y1, unsigned int color);


/* 函数声明 */

#endif //INC_15_LCD_BSP_LCD_H